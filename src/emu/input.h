...
//  add digital hat mappings
    JOYCODE_HAT1LEFT_SWITCH  = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, HAT1LEFT),
	JOYCODE_HAT1RIGHT_SWITCH = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, HAT1RIGHT),
	JOYCODE_HAT1UP_SWITCH    = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, HAT1UP),
	JOYCODE_HAT1DOWN_SWITCH  = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, HAT1DOWN),    
};
